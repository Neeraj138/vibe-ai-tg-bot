...
exports.getProgramTvlTimeSeries = getProgramTvlTimeSeries;
/**
 * Fetch TVL time series for a Solana program from Vybe Network.
 */
function getProgramTvlTimeSeries(agent, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error((error === null || error === void 0 ? void 0 : error.message) || "Failed to fetch program TVL");
            }
...
//# sourceMappingURL=get_program_tvl_ts.js.map