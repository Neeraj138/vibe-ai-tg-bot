 ...
 */
function getTopTokenHolders(agent, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (input.sortByAsc)
            params.append("sortByAsc", input.sortByAsc);
        if (input.sortByDesc)
            params.append("sortByDesc", input.sortByDesc);
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error((error === null || error === void 0 ? void 0 : error.message) || "Failed to fetch top token holders");
            }
...
//# sourceMappingURL=get_top_token_holders.js.map