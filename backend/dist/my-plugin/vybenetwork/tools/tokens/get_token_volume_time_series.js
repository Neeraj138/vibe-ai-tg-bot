...
exports.getTokenVolumeTimeSeries = getTokenVolumeTimeSeries;
/**
 * Fetches the token transfer volume (amount and USD) over a selected time period.
 */
function getTokenVolumeTimeSeries(agent, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error((error === null || error === void 0 ? void 0 : error.message) || "Failed to fetch token volume time series");
            }
...
//# sourceMappingURL=get_token_volume_time_series.js.map